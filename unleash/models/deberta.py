...
# from unleash.parsing.encoder_base_parsing import map_template
...
class DebertaForLogParsing(ModelBase):
    def __init__(self, 
                 model_path, 
        ...
        self.plm = DebertaForMaskedLM.from_pretrained(self.model_path)
    ...
    def add_label_token(self, num_tokens: int):
        crr_tokens, _ = self.plm.deberta.embeddings.word_embeddings.weight.shape
